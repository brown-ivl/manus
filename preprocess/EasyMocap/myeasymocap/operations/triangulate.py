...
class SimpleTriangulate:
    ...
    def __call__(self, keypoints, cameras, undistort = True):
        '''
            keypoints: [nViews, nJoints, 3]
        ...
        if self.mode == 'naive':
            ...
            keypoints3d, k2d = iterative_triangulate(keypoints, cameras['P'], dist_max=25, min_conf=0.1)
